...
# ==========================================================
# Cardioid Point Generation and Kernel Matrix Construction
# ==========================================================
# Generates:
#   1. Boundary points
#   2. Interior points
#   3. Outward unit normals
#   4. Neumann kernel matrix K
#
...
# ==========================================================
# 9. Asymmetric Kernel Parameters
# ==========================================================
lambda_param = 1500.0
...
# ==========================================================
# 10. Prepare Boundary Arrays
# ==========================================================
boundary_points_np = boundary_pts.astype(np.float64)

normals_np = normals.astype(np.float64)

N = boundary_points_np.shape[0]
...
# ==========================================================
# 11. Pairwise Differences
# ==========================================================
# Shape:
#   diffs -> (N, N, 2)
# ==========================================================
r_i = boundary_points_np[:, None, :]
r_j = boundary_points_np[None, :, :]
...
A = (
    -2 * lambda_param
    * np.exp(-lambda_param * squared_distances)
)


# ==========================================================
# 14. Final Kernel Matrix
# ==========================================================
K = A * dot_matrix
...
print(" - data/cardioid_K_matrix.npy")
